    ...
    if (edit) {
        ...
        for (int i = 0; i < requestCount; i++) {
            if (requests[i].name == requestName) {
                ...
                cout << "Enter new recipient contact : ";
                string newContact;
                cin >> newContact;
                if (!newContact.empty()) {
...
void deleteDonorOrRecipient() {
    clearScreen();
    int choice;
    cout << "==============================" << endl;
    cout << "| DELETE MENU                |" << endl;
    cout << "==============================" << endl;
    cout << "1. Delete a Donor" << endl;
    cout << "2. Delete a Recipient (Request)" << endl;
    ...
    if (choice == 1) {
        ...
        bool found = false;
        for (int i = 0; i < donationCount; i++) {
            if (donations[i].name == name) {
                // Shift elements to the left
                for (int j = i; j < donationCount - 1; j++) {
        ...
        string name;
        cout << "Enter the name of the recipient to delete: ";
        cin >> name;
        bool found = false;
        for (int i = 0; i < requestCount; i++) {
            if (requests[i].name == name) {
                ...
                requestCount--;
                cout << "Recipient \"" << name << "\" deleted successfully." << endl;
                found = true;
                break;
            }
        }
...
void adminDashboard() {
    ...
    do {
        ...
        cout << "4.Delete Donor or Recipient" << endl;
        cout << "5. View History and Reports" << endl;
        cout << "6. Logout" << endl;
        cout << "Enter your choice: ";
        cin >> choice;
